...
import UserRegisterForm from "@/components/elements/UserRegisterForm.vue";
...
const quotes = [
  ...
  {
    text: "El acto de escribir es el acto de descubrir lo que uno piensa.",
    author: "David Hare",
  },
  {
    text:
  ...
  {
    text: "El escritor es un mundo atrapado en una persona.",
    author: "Victor Hugo",
  },
  {
    text: "Un lector vive mil vidas antes de morir… Aquel que no lee sólo vive una",
    ...
    <div class="lg:p-8">
      <div class="mx-auto flex w-full flex-col justify-center space-y-5 sm:w-[350px]">
        <div class="flex flex-col space-y-2 text-center">
          <h1 class="text-2xl font-semibold tracking-tight">¡Forma parte de Werply!</h1>
          <p class="text-sm text-muted-foreground">
            Ingrese su email a continuación para crear su cuenta
          </p>
        </div>
        <UserRegisterForm />
