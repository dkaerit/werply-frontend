...
<template>
  <Toggle @click="toggleTheme" class="elevation-0 px-1.5" icon>
    <div class="icon-theme" v-if="isDarkMode">
      <!-- white moon in dark -->
      <svg height="25px" id="Layer_1" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
